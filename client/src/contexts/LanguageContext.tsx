...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "contact.address.text": "College of Forestry, Beijing Forestry University, No. 35 Tsinghua East Road, Haidian District, Beijing 100083, China",
  ...
  zh: {
    ...
    "contact.address.text": "北京市海淀区清华东路35号 北京林业大学林学院 100083",
